...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-background-main">
      <div className="bg-footer-dark text-white hidden md:block">
        <Container>
          <div className="flex items-center justify-between py-2 text-sm">
            <div className="flex items-center gap-4 lg:gap-6">
              <a
                href="tel:+18573120663"
                className="flex items-center gap-2 hover:text-brand-primary transition-colors text-xs lg:text-sm"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
                ...
                <span className="hidden lg:inline">+857-312-0663</span>
              </a>
              <a
                href="#"
                className="hidden lg:flex items-center gap-2 hover:text-brand-primary transition-colors text-xs lg:text-sm"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
      ...
      <div className="bg-background-main border-b border-gray-200">
        <Container>
          ...
          <Container>
            <div className="py-4 space-y-1">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === link.href
                      ...
                      : "text-gray-700 hover:bg-background-light",
                  )}
                >
                  {link.label}
                </Link>
              ...
              <div className="px-4 pt-4 mt-4 border-t border-gray-200">
                <a
                  href="tel:+18573120663"
                  className="flex items-center gap-2 text-gray-700 hover:text-brand-primary py-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
