    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
      <div>
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          Voice Tabernacle Multi Services Center is dedicated to empowering
          underserved youth and families in Mattapan through comprehensive
          programs and community partnerships. We provide support, guidance, and
          resources to help every individual achieve stability, success, and
      ...
      <div className="relative">
        ...
        <img
          ...
          alt="Community programs and services"
